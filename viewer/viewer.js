  ...
  happy: [
    ...
    { // ⑤ バイバイ
      ...
      bones: {
        ...
        head                : { x: 0.1, y: 0, z: 0 },
        leftShoulder        : { x: 0.26, y: 0.18, z: -0.06 },
        leftUpperArm        : { x: -0.06, y: -0.77, z: -1.09 },
        leftLowerArm        : { x: -0.22, y: -0.46, z: -0.06 },
        leftHand            : { x: 0.02, y: -0.22, z: -0.7 },
        rightShoulder       : { x: 0.1, y: -0.06, z: -0.06 },
        rightUpperArm       : { x: -0.38, y: -0.54, z: 1.22 },
        rightLowerArm       : { x: 2.726, y: 0.6139, z: -3.1416 },
        rightHand           : { x: 0.34, y: -0.22, z: 0.1 },
        leftThumbProximal   : { x: 1.22, y: 0, z: 0 },
      }
    }
  ],
  surprised: [
